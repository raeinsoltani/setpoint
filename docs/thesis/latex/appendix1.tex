...
می‌کند و بستن درِ دستگاه را متوقف نمی‌کند. خواب میزبان برای بازوهای پیش‌بینانه \emph{بازیابی‌ناپذیر}
...
تحویل‌شده. زمان واکنش، میانه‌ی زمان رسیدن به نیاز پس از هر پله‌ی بالارونده است و پله‌ای که هرگز
به آن نرسیده «بی‌نهایت» شمرده می‌شود. علامت «\lr{---}» یعنی این میانه بی‌نهایت است، یعنی ناوگان در
بیشتر پله‌ها تا پایان پنجره به عدد لازم نرسید \mdash{} یا در بازوهای ایستا، کنترل‌گری در کار نیست.
این یک عدد گمشده نیست، بلکه خود نتیجه است. زمان واکنش بازوی فروپاشیده (با علامت $^{*}$) معنایی
ندارد: کنترل‌گری که در هر چرخه جهت عوض می‌کند، از سر اتفاق از عدد لازم می‌گذرد، و ارقام کوچک آن
نشانه‌ی سرعت نیست.
...
بازوی آخر، سنجه‌ی داخلی مقیاس‌گذار ۱۳۵ درصد (میانه) از بار مشاهده‌شده‌ی هر نمونه واگرا شد (اختلاف زمان نمونه‌برداری و نه شاهد پس‌خور؛ بخش~\ref{sec:validity-metricdiff}).
...
\arm{ours-threshold} & \lr{3.3\%} & \lr{12,365} & \lr{1,410} & \lr{4,015} & \lr{2,088.1} & \lr{---} & \lr{9/9} & \lr{5} \\
...
\arm{ours-pred.-per-rep.-nostab} & \lr{42.8\%} & \lr{7,685} & \lr{4,145} & \lr{2,070} & \lr{1,635.4} & \lr{40.0$^{*}$} & \lr{49/50} & \lr{98} \\
\hline
\end{tabular}
\end{table}
...
مقیاس‌گذار ۸۶ درصد (میانه) واگرا شد (اختلاف زمان نمونه‌برداری و نه شاهد پس‌خور؛ بخش~\ref{sec:validity-metricdiff}).
...
\arm{ours-threshold} & \lr{4.1\%} & \lr{11,810} & \lr{1,460} & \lr{0} & \lr{2,476.7} & \lr{117.5} & \lr{8/0} & \lr{0} \\
...
سنجه‌ی داخلی مقیاس‌گذار ۸۸ درصد (میانه) واگرا شد (اختلاف زمان نمونه‌برداری و نه شاهد پس‌خور؛ بخش~\ref{sec:validity-metricdiff}).
