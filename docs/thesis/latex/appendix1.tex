...
%=============================================================================
\section*{پیوست الف — پیکربندی}
\addcontentsline{toc}{section}{پیوست الف — پیکربندی}
%=============================================================================
...
%=============================================================================
\section*{پیوست ب — راهنمای بازتولید آزمایش‌ها}
\addcontentsline{toc}{section}{پیوست ب — راهنمای بازتولید}
%=============================================================================
...
%=============================================================================
\section*{پیوست ج — جدول‌های کامل نتایج}
\addcontentsline{toc}{section}{پیوست ج — جدول‌های کامل نتایج}
%=============================================================================
...
تحویل‌شده. علامت «---» در ستون زمان واکنش یعنی ناوگان تا پایان پنجره هرگز به عدد لازم نرسید؛
این یک عدد گمشده نیست، بلکه خود نتیجه است.

\begin{table}[H]
\centering
\scriptsize
\caption{نتایج کامل — \arm{spike}}
\label{tab:app-spike}
\begin{tabular}{|l|r|r|r|r|r|r|r|r|}
\hline
\textbf{بازو} & \textbf{SLA} & \textbf{نمونه‑ث} & \textbf{کم‌تأمین} & \textbf{بیش‌تأمین} & \textbf{هسته‑ث} & \textbf{واکنش} & \textbf{↑/↓} & \textbf{جهت} \\
\hline
...
\centering
\scriptsize
\caption{نتایج کامل — \arm{diurnal}}
